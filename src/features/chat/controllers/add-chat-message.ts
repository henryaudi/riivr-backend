...
import { addChatSchema } from '@chat/validations/chat';
...
export class Add {
  ...
  public async message(req: Request, res: Response): Promise<void> {
    ...
    const conversationObjectId: ObjectId = conversationId ? new ObjectId(conversationId as string) : new ObjectId();
  ...
  private async messageNotification({
    ...
    if (cachedUser.notifications.messages) {
      // Email notification to receiver turning on their 'messages' settings.
