...
class Config {
  ...
  public POSTMARK_API_KEY: string | undefined;
  public POSTMARK_SENDER: string | undefined;
  ...
  constructor() {
    ...
    this.POSTMARK_API_KEY = process.env.POSTMARK_API_KEY || '';
    this.POSTMARK_SENDER = process.env.POSTMARK_SENDER || '';
